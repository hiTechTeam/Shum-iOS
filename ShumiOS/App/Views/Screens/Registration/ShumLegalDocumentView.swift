...
struct ShumLegalDocumentView: View {
    ...
    private var content: ShumLegalContent {
        document.content(isRussian: isRussian)
    }
    ...
    func content(isRussian: Bool) -> ShumLegalContent {
        ...
        case (.privacy, true):
            return ShumLegalContent(
                ...
                updatedAt: "Обновлено 13 сентября 2026 года",
                introduction: "Shum — мессенджер без центрального сервера учётных записей. Для работы не нужны номер телефона, адрес электронной почты или внешний аккаунт.",
                sections: [
                    ShumLegalSection(
                        title: "Какие данные использует Shum",
                        paragraphs: [
        ...
        case (.terms, true):
            return ShumLegalContent(
                ...
                updatedAt: "Обновлено 13 сентября 2026 года",
                introduction: "Shum позволяет находить людей рядом по Bluetooth и обмениваться зашифрованными сообщениями напрямую или через общедоступные Nostr-релеи.",
                sections: [
                    ShumLegalSection(
                        title: "Основные правила",
                        paragraphs: [
                            "Используя Shum, вы соглашаетесь соблюдать следующие правила:"
                        ],
                        bullets: [
