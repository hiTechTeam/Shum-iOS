...
struct LocalCardTests {
    ...
    @Test func usernameValidationDoesNotClaimTelegramOwnership() {
        #expect(LocalCardManifest.username(" @ruslan_11 ") == "ruslan_11")
        #expect(LocalCardManifest.username("https://t.me/ruslan_11") == nil)
    ...
    @Test func profileEditorsShowOnlyTheirOwnField() {
        ...
        #expect(LocalCardDetailsMode.telegram.showsUsername)
        #expect(!LocalCardDetailsMode.telegram.showsName)
    ...
    @Test func blocksStopProfileAcceptance() throws {
        ...
        defaults.set([bob.body.id.uuidString.lowercased()], forKey: "telescan.blocked-profile-ids")
